...
def generate_starting_grid(grid_width=10, grid_height=10):
    ...
    # print(all_ship_coordinates[0])
    # return all_ship_coordinates[0]
    flat_list = [item for sublist in all_ship_coordinates for item in sublist]
    print(flat_list)
    return(flat_list)
